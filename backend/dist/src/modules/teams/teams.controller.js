...
let TeamsController = class TeamsController {
    ...
    findAll(q) { return this.teams.findAll(q.page, q.limit, q.country); }
    findOne(id) { return this.teams.findOne(id); }
    create(body, req) { return this.teams.create(body, req.user.id); }
    invite(id, body, req) {
