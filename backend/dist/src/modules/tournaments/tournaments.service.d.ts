...
export declare class TournamentsService {
    ...
    create(dto: CreateTournamentDto, adminId: string): Promise<{
        id: string;
        status: import(".prisma/client").$Enums.TournamentStatus;
        createdAt: Date;
        updatedAt: Date;
    ...
    registerTeam(tournamentId: string, teamId: string, userId: string): Promise<{
        id: string;
        status: import(".prisma/client").$Enums.RegistrationStatus;
        userId: string;
        teamId: string;
    ...
    reportMatchResult(matchId: string, winnerId: string, score1: number, score2: number, adminId: string): Promise<{
        team1: {
            id: string;
            country: string | null;
            status: import(".prisma/client").$Enums.TeamStatus;
