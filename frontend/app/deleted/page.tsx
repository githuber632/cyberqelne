...
export default function DeletedPage() {
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-cyber-dark">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-96 h-96 bg-cyber-purple/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      >
        <div className="glass-card rounded-2xl p-8">
          ...
          <p className="text-gray-400 text-sm leading-relaxed mb-2">
            Ваш аккаунт был удалён администрацией CyberQELN.
          </p>
          <p className="text-gray-500 text-sm mb-8">
            Если вы считаете это ошибкой — свяжитесь с поддержкой в Telegram.
          </p>
