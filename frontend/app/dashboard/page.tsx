...
import {
  Trophy, Users, TrendingUp, Settings,
  Plus, GamepadIcon, BarChart3, LogOut, Save, Camera,
} from "lucide-react";
...
const sidebarItems = [
  ...
  { label: "Статистика", icon: TrendingUp, id: "stats" },
  { label: "Турниры", icon: Trophy, id: "tournaments" },
  { label: "Команда", icon: Users, id: "team" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}
              ...
              <div className="relative">
                ...
                <div className="mb-3">
                  <FileUpload compact storagePath="avatars" onUpload={(url) => updateUser({ avatar: url })} />
                </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              {[
                { label: "Роль", value: user.role, icon: TrendingUp, color: "text-cyber-neon" },
                { label: "Турниров", value: activeTournaments.length, icon: Trophy, color: "text-green-400" },
                { label: "ID", value: user.id.slice(0, 6), icon: GamepadIcon, color: "text-cyber-neon-pink" },
              ].map((stat, i) => (
                <motion.div key={stat.label} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.1 + i * 0.05 }} className="stat-card">
